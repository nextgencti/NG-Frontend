...
import { Play, RotateCcw, ArrowLeft, BookOpen, Award, Zap, Maximize, Minimize } from 'lucide-react';
    ...
    <div ref={containerRef} className={`w-full text-center max-w-4xl mx-auto ${isFullscreen ? 'bg-[#0B091B] h-screen p-6 md:p-10 overflow-y-auto' : ''}`}>
      ...
      {gameState === 'lobby' && (
        <div className="bg-[#151230]/75 border border-indigo-500/20 rounded-2xl p-6 text-center max-w-sm mx-auto shadow-2xl animate-in zoom-in-95 mt-2">
          ...
          <h3 className="text-lg font-black text-white mb-1">Quote Typing</h3>
      ...
      {gameState === 'playing' && (
        <div className="w-full flex flex-col gap-4 max-w-md mx-auto mt-2">
          ...
          <div 
            ...
            className="bg-[#151230]/70 border border-indigo-500/20 hover:border-indigo-500/30 rounded-2xl p-5 shadow-2xl relative cursor-text min-h-[120px] text-left leading-relaxed flex items-center justify-center select-none"
          >
      ...
      {gameState === 'gameover' && (
        <div className="bg-[#151230]/75 border border-indigo-500/20 rounded-2xl p-6 text-center max-w-sm mx-auto shadow-2xl animate-in zoom-in-95 mt-2">
          ...
          <h3 className="text-lg font-black text-white mb-1">Quote Completed!</h3>
          ...
          {!isAuthenticated && (
            <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-2.5 mb-4 text-[9.5px] text-amber-300 font-semibold leading-relaxed">
          ...
          <div className="flex gap-2.5">
            ...
            >
              <RotateCcw className="w-4 h-4" /> Next Quote
            </button>
            <button
              onClick={onBack}
