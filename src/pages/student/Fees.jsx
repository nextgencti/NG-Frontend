  ...
  return (
    ...
    >
      ...
      {selectedTxn && (() => {
        const dateTime = getTransactionDateTime(selectedTxn);
        return (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 lg:pl-[var(--sidebar-width)] bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200 text-slate-805 print-receipt-overlay">
